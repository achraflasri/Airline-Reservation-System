...
public class statistique_par_mois_menu extends JFrame {
	private static final long serialVersionUID = 1L;
	
	public statistique_par_mois_menu() {
	...
	JLabel lblBienvenuDansLespace = new JLabel("Choix de stati par mois");
	...
	JLabel lblNewLabel = new JLabel("Par chiffres d'affaires");
	...
	lblNewLabel_1.setIcon(new ImageIcon(this.getClass().getResource("/eedf (1).PNG")));
	lblNewLabel_1.setBounds(41, 39, 149, 134);
	panel_1.add(lblNewLabel_1);
	
	JPanel panel_2 = new JPanel();
	JLabel lblGestionDeDonnes = new JLabel("Par nombre reservation");
	...
	panel_2.addMouseListener(new MouseAdapter() {
		...
		@Override
		public void mouseClicked(MouseEvent arg0) {
			new statistique_par_mois_reservation();
			dispose();
	...
	label.setIcon(new ImageIcon(this.getClass().getResource("/eedf (2).PNG")));
	label.setBounds(25, 43, 180, 134);
	panel_2.add(label);
