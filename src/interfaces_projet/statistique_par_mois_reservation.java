...
public class statistique_par_mois_reservation extends JFrame {
    ...
    public statistique_par_mois_reservation() {
    ...
    private CategoryDataset createDataset() {
    	...
    	try {
			...
			while(rs.next()){
				dataset.setValue(rs.getInt(2), "X", rs.getString(1));
			}
		} catch (Exception e) {
    ...
    private JFreeChart createChart(CategoryDataset dataset) {
    	JFreeChart chart = ChartFactory.createBarChart("Nombre de Reservation par Mois", "M o i s", "Nombre Reservation", dataset, PlotOrientation.VERTICAL, true, true, true);
